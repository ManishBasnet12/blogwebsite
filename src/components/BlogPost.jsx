...
function BlogPost({ img, price, category, title, summary, slug }) {
  return (
    <Link
      href={`/blog/${slug}`}
      className="text-state-500 flex flex-col gap-2 shadow-sm bg-slate-200 group"
    >
      <div className="overflow-hidden">
        <Image
          className="w-[100%] aspect-[1] object-cover transition-transform duration-300 group-hover:scale-110"
          src={img}
          width={100}
          height={100}
          alt="blog image"
